            ...
            <div class="easyui-accordion" data-options="fit:true,border:false">
                <div id="" title="交易管理" >
                    ...
                    <ul class="treeMenu" class="easyui-tree">
                        ...
                        <li data-options="attributes:{url:'kehu/khrecord.jsp'}">查询交易记录</li>
                    </ul>
                </div>
                <div id="" title="个人信息管理">
					<!--创建菜单-->
                    <ul class="treeMenu" class="easyui-tree">
                        <li data-options="attributes:{url:'kehu/khinformation.jsp'}">个人信息管理</li>
                    </ul>
                </div>
        ...
        <div data-options="region:'center'">
            ...
            <div id="div_tabs" class="easyui-tabs" data-options="fit:true,border:false">
                ...
                <div id="" title="首页" style="text-align:center;margin-top: 200px">
					...
					<h1 align="center">欢迎进入中国银行客户操作系统</h1>
					<br>
