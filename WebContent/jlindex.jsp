            ...
            <div class="easyui-accordion" data-options="fit:true,border:false">
                <div id="" title="职员信息管理">
                    ...
                    <ul class="treeMenu" class="easyui-tree">
                        <li data-options="attributes:{url:'employee/information.jsp'}">职员信息管理</li>
                    </ul>
                </div>
				<div id="" title="职员账号管理">
					<!--创建菜单-->
                    <ul class="treeMenu" class="easyui-tree">
                        <li data-options="attributes:{url:'admin_num/information.jsp'}">职员账户管理</li>
                    </ul>
                </div>
            </div>
        ...
        <div data-options="region:'center'">
            ...
            <div id="div_tabs" class="easyui-tabs" data-options="fit:true,border:false">
                ...
                <div id="" title="首页" style="text-align:center;margin-top: 200px">
					...
					<h1 align="center">欢迎进入中国银行经理操作系统</h1>
					<br>
