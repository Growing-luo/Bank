...
%>
<form action="${pageContext.request.contextPath }/QukuanServlet" method="post">
	<div>
        <h1>取款</h1>
    </div>
    <div>
    ...
    <div>
        <input class="easyui-linkbutton" type="submit" value="取款 " style="width:100%;height:35px;background: #3d83fa;color: #fefefe;" />
    </div>
	<div>
