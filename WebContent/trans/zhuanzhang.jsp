...
<form action="${pageContext.request.contextPath }/ZhuanzhangServlet" method="post">
    ...
    <div>
        <input class="easyui-textbox" name="in_account_num" data-options="iconCls:'icon-man',iconWidth:30,iconAlign:'left',required:true,prompt:'转入账户'" style="width:100%;height:35px;" />
    </div>
    <div>
        <input class="easyui-textbox" name="amount" data-options="iconCls:'icon-yuan',iconWidth:30,iconAlign:'left',required:true,prompt:'金额'" style="width:100%;height:35px;" />
    </div>
    <div>
        <input class="easyui-linkbutton" type="submit" value="确认转账" style="width:100%;height:35px;background: #3d83fa;color: #fefefe;" />
    </div>
	<div>
